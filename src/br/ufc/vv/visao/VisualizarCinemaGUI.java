...
public class VisualizarCinemaGUI {
	...
	public VisualizarCinemaGUI() {
		while(cinemaExiste() == false){
			...
			String endereco = JOptionPane.showInputDialog("Digite o endereço do cinema!");
	...
	private void initialize() {
		...
		JButton btnEditarInformaes = new JButton("Editar Informações");
		...
		JLabel lblVejaANossa = new JLabel("Confira a nossa programação!");
		...
		JButton btnProgramao = new JButton("Programação");
